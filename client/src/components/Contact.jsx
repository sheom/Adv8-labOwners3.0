    ...
    try {
      ...
      const res = await fetch('/api/booking/create', {
        ...
        body: JSON.stringify({
          ...
          bookedUserName:currentUser.username,
          labRef: listing._id,
          labName:listing.name
        }),
      });
      const data = await res.json();
      setLoading(false);
      ...
      {landlord && (
        ...
        <div>
            <form onSubmit={handleSubmit} >
                  ...
                  <div className='flex flex-col flex-1 gap-4'>
                    <p className='font-semibold'>
                      ...
                      <span className='font-normal text-gray-600 ml-2'>
                        Please upload your priscriotion
                      </span>
                    </p>
              ...
              <br/>
              <hr />
              <div className=' mt-5 flex flex-col flex-1 gap-4 px-10 '>
              <button
                      disabled={loading || uploading}
                      className='p-3 bg-slate-700 text-white rounded-lg uppercase hover:opacity-95 disabled:opacity-80 w-xl'
                    >
